...
func (c *userServiceClient) CreateUser(ctx context.Context, in *UserRequest, opts ...grpc.CallOption) (*EmptyResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
type UserServiceServer interface {
	...
	CreateUser(context.Context, *UserRequest) (*EmptyResponse, error)
...
func (UnimplementedUserServiceServer) CreateUser(context.Context, *UserRequest) (*EmptyResponse, error) {
