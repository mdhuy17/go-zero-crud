...
func (c *companyServiceClient) CreateCompany(ctx context.Context, in *CompanyRequest, opts ...grpc.CallOption) (*EmptyResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
type CompanyServiceServer interface {
	...
	CreateCompany(context.Context, *CompanyRequest) (*EmptyResponse, error)
...
func (UnimplementedCompanyServiceServer) CreateCompany(context.Context, *CompanyRequest) (*EmptyResponse, error) {
